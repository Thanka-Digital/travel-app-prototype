...
export const SplashScreenHeader = ({ text }: { text: string }) => {
  return <p className="text-2xl font-medium text-black">{text}</p>;
};
  ...
  return (
    <label className="inline-flex">
      <input
        ...
        onClick={(e) => handleClick(text, e.currentTarget.checked)}
      />
      <div className="p-3 rounded-lg bg-white text-secondary border-2 peer-checked:border-primary peer-checked:text-primary peer-checked:bg-primary peer-checked:bg-opacity-20 transition duration-200">
    ...
    <main className="bg-splash1 h-screen">
      <div className="mask-gradient flex flex-col gap-10 absolute bottom-0 bg-white py-12 px-8">
        <section className="flex flex-col items-center">
          <SplashScreenHeader text="What Kind of traveler" />
          <SplashScreenHeader text="are you?" />
        </section>
